...
proc showSubMenu {fm {mtype 0}} {
    ...
    set ::tsubmenu [cmenu new $tekwin$fm -tongue "0.45 0.5 0.55 5m" -strokewidth 2 -pad 1m -fillnormal snow -stroke gray70 -direction $direct -place $mplace]
...
pack [$r0 canvas] -in $t.frame  -side top -padx "1c 0" -pady "5m 0" -anchor nw
pack [$r1 canvas] -in $t.frame  -side top -padx "1c 0" -pady 3m -anchor nw
