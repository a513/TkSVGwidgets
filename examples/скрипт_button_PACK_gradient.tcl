...
update
#SVG-фрейм
set b1 [cbutton new $t.frame -type frame -rx 5m  -follopacity 1.0]
...
set xa3 [cbutton new $t.but33 -type ellipse  -text Эллипс -fontweight bold -fontslant italic -fontfamily helvetica -fontsize 4m ]
[$xa3 canvas] configure -bg [$b1 config -fillnormal]
set xa4 [cbutton new $t.but44 -type rect  -text {ВЫХОД (Закругленный)} -rx 2m -command "exitarm $t" -textfill red -fontweight bold -fontsize 4m]
...
#SVG-фрейм с заголовком
    set clfrv [cframe new $t.rgch -type clframe -text "radio/check кнопки" -rx 5m -strokewidth 1 -stroke red -fillnormal snow -follopacity 1.0]
    $clfrv boxtext
